...
<section class="bgwhite p-t-45 p-b-58">
		<div class="container">
			...
			<?php
				...
				$qq = "SELECT book_id FROM books_read WHERE user_id =" . $user_id;
				$q = "SELECT book_id FROM books WHERE book_id NOT IN (".$qq.")";
				$q2="select cat_id from category";
				$q3 = "SELECT b.book_id,b.book_name,b.image_url FROM books AS b JOIN ratings AS r ON b.rating_id=r.rating_id WHERE b.cat_id IN(".$q2.") AND book_id IN(".$q.") ORDER BY r.avg_rating DESC LIMIT 8";
							...
							<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
								...
								<div class="block2">
									...
									<div class="block2-txt p-t-20">
										<a href="book_detail.php?id=<?php echo $book_id; ?>" class="block2-name dis-block s-text3 p-b-5">
											<?php echo $name; ?>
										</a>
									</div>
								</div>
