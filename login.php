			...
			if(user_email!=""&&user_pswd!="")
			{
				...
				xhttp.onreadystatechange = function() {
				    ...
				    if (this.readyState == 4 && this.status == 200) {
						...
						if(response=="Success")
						{
				 			document.getElementById('ans').innerHTML="Logged In Successfully";
							setTimeout(function(){
								window.location = "dashboard.php";
							},3000);
						}
						else if("Error") document.getElementById('ans').innerHTML="There was an Error Handling Your Request";
						else if("Incorrect") document.getElementById('ans').innerHTML="Email or Password is Incorrect";
						else if("ErrorDB") document.getElementById('ans').innerHTML="Error Connecting to Database";
				    }
				  };
				  xhttp.open("POST", "loginmember.php", true);
				  xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
				  xhttp.send("email="+user_email+"&password="+user_pswd);
			}
			  return false;
		}
	</script>
